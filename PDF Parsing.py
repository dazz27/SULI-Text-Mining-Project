...
def search_bioRxiv(queries):
    for query in queries:
        ...
        URL = "https://www.biorxiv.org/search/" + query + "%20jcode%3Abiorxiv%20numresults%3A10%20sort%3Arelevance-rank%20format_result%3Astandard"
        ...
        print(resultStats)
        #Accessing articles
        results = soup.find_all(href=True, class_='highwire-cite-linked-title', limit=3)
        for link in results:
